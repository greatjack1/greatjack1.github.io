! function(t) {
        ...
        var r = t("html, body"),
            ...
            u = function(o, l) {
                ...
                return l = t.extend({}, t.fn.smoothState.options, l), null === e.history.state ? (d = l.alterChangeState({
                    id: h
                }, i.title, m), e.history.replaceState(d, i.title, m)) : d = {}, a.storePageIn(p, m, i.documentElement.outerHTML, h, d), a.triggerAllAnimationEndEvent(u, "ss.onStartEnd ss.onProgressEnd ss.onEndEnd"), O(u), {
                    href: m,
                    cache: p,
                    clear: R,
                    load: y,
    ...
    if (!n.TweenLite) {
        ...
        var M = _("TweenLite", function(e, i, n) {
                ...
                if (this._overwrite = l = null == l ? G[M.defaultOverwrite] : "number" == typeof l ? l >> 0 : G[l], (a || e instanceof Array || e.push && d(e)) && "number" != typeof e[0])
        ...
        o._init = function() {
            ...
            if (this._ease = u = u ? u instanceof x ? u : "function" == typeof u ? new x(u, s.easeParams) : w[u] || M.defaultEase : M.defaultEase, s.easeParams instanceof Array && u.config && (this._ease = u.config.apply(u, s.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)
            ...
            for (s in this.vars)
                if (h = this.vars[s], U[s]) h && (h instanceof Array || h.push && d(h)) && -1 !== h.join("").indexOf("{self}") && (this.vars[s] = h = this._swapSelfInParams(h, this));
        ...
        _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
            ...
            var h, c, f, p, d, m, R = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                ...
                J = function(t, e) {
                    ...
                    if (e = e || Q(t, null))
                        if (i = e.length)
                            for (; --i > -1;) r = e[i], (-1 === r.indexOf("-transform") || Pt === r) && (s[r.replace(P, O)] = e.getPropertyValue(r));
                        else
            ...
            var pt = function(t, e, i, n) {
                ...
                _t = o.parseComplex = function(t, e, i, n, r, s, a, l, u, c) {
                    ...
                    var f, p, d, m, _, v, y, x, w, b, T, z, P, k = i.split(", ").join(",").split(" "),
                        O = n.split(", ").join(",").split(" "),
                        C = k.length,
                        S = h !== !1;
                    for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (k = k.join(" ").replace(M, ", ").split(" "), O = O.join(" ").replace(M, ", ").split(" "), C = k.length), C !== O.length && (k = (s || "").split(" "), C = k.length), a.plugin = u, a.setRatio = c, ft.lastIndex = 0, f = 0; C > f; f++)
                        if (m = k[f], _ = O[f], x = parseFloat(m), x || 0 === x) a.appendXtra("", x, st(_, x), _.replace(g, ""), S && -1 !== _.indexOf("px"), !0);
            ...
            var bt, Tt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                zt = W("transform"),
                Pt = G + "transform",
                kt = W("transformOrigin"),
                Ot = null !== W("perspective"),
                ...
                jt = Y.getTransform = function(t, i, n, r) {
                    ...
                    var s, a, l, u, h, c, f = n ? t._gsTransform || new Ct : new Ct,
                        ...
                        d = 2e-5,
                        m = 1e5,
                        R = Ot ? parseFloat(Z(t, kt, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin || 0 : 0,
                ...
                Yt = Y.set3DTransformRatio = Y.setTransformRatio = function(t) {
                    ...
                    if (p && (m = 1e-4, m > S && S > -m && (S = M = 2e-5), m > A && A > -m && (A = M = 2e-5), !X || z.z || z.rotationX || z.rotationY || (X = 0)), k || z.skewX) k *= N, R = e = Math.cos(k), g = r = Math.sin(k), z.skewX && (k -= z.skewX * N, R = Math.cos(k), g = Math.sin(k), "simple" === z.skewType && (_ = Math.tan(z.skewX * N), _ = Math.sqrt(1 + _ * _), R *= _, g *= _, z.skewY && (e *= _, r *= _))), i = -g, s = R;
                    else {
            ...
            u = Ct.prototype, u.x = u.y = u.z = u.skewX = u.skewY = u.rotation = u.rotationX = u.rotationY = u.zOrigin = u.xPercent = u.yPercent = u.xOffset = u.yOffset = 0, u.scaleX = u.scaleY = u.scaleZ = 1, xt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                parser: function(t, e, i, n, s, a, l) {
                    ...
                    var u, h, c, f, p, d, m, R, g, _ = t._gsTransform,
                        ...
                        b = {},
                        T = "transformOrigin",
                        z = jt(t, r, !0, l.parseTransform);
                    if (n._transform = z, "string" == typeof w.transform && zt) h = j.style, h[zt] = w.transform, h.display = "block", h.position = "absolute", L.body.appendChild(j), u = jt(j, null, !1), z.svg && (m = z.xOrigin, R = z.yOrigin, u.x -= z.xOffset, u.y -= z.yOffset, (w.transformOrigin || w.svgOrigin) && (c = {}, Nt(t, rt(w.transformOrigin), c, w.svgOrigin, w.smoothOrigin, !0), m = c.xOrigin, R = c.yOrigin, u.x -= c.xOffset - z.xOffset, u.y -= c.yOffset - z.yOffset), (m || R) && (g = Xt(j, !0), u.x -= m - (m * g[0] + R * g[2]), u.y -= R - (m * g[1] + R * g[3]))), L.body.removeChild(j), u.perspective || (u.perspective = z.perspective), null != w.xPercent && (u.xPercent = ot(w.xPercent, z.xPercent)), null != w.yPercent && (u.yPercent = ot(w.yPercent, z.yPercent));
            ...
            var Ut = function(t) {
                if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                    ...
                    if ("all" === this.e) o.cssText = "", r = !0;
                        ...
                        for (e = this.e.split(" ").join("").split(","), n = e.length; --n > -1;) i = e[n], l[i] && (l[i].parse === a ? r = !0 : i = "transformOrigin" === i ? kt : l[i].p), Bt(o, i);
            ...
            var Ht = function(t, e, i) {
                ...
                if (t.slice)
                    ...
                    for (n = t.childNodes, r = n.length; --r > -1;) s = n[r], o = s.type, s.style && (e.push(J(s)), i && i.push(s)), 1 !== o && 9 !== o && 11 !== o || !s.childNodes.length || Ht(s, e, i)
            };
            return o.cascadeTo = function(t, i, n) {
                ...
                for (t = l._targets || l.target, Ht(t, h, f), l.render(i, !0, !0), Ht(t, c), l.render(0, !0, !0), l._enabled(!0), r = f.length; --r > -1;)
        ...
        var e = function(e) {
            ...
            i = function() {
                ...
                t(document).on("click", "#change-theme", function(e) {
                    e.preventDefault(), t("body").hasClass("bright-theme") ? (t("body").removeClass("bright-theme"), Cookie.create("theme", "default", 0)) : (t("body").addClass("bright-theme"), Cookie.create("theme", "bright", 0))
//                    t("body").hasClass("bright-theme") ? (t("body").addClass("bright-theme"), Cookie.create("theme", "default", 0)) 
                })
            },
            n = function() {
